...
PROJECT = {
  "code": "P18",
  "slug": "para-fire-seasonality-analysis",
  "title": "Para Fire Seasonality Analysis",
  ...
  "kind": "fires",
  "dataset": "INPE/INMET-style fire and rainfall sample",
  "source": "https://queimadas.dgi.inpe.br/",
  "description": "Fire seasonality lab for Para with monthly aggregation, rainfall comparison, and correlation.",
  "concepts": [
    "time groupby",
    "corr",
    "subplots",
